...
const initValues = {
  ...
  email:'',
  telefon:'',
  subject:'Programare: PACHET DE 4 + 2 ȘEDINȚE',
  message:''
}

const initState = {values:initValues}

export default function ProgramarePachet({data}){
  ...
  return(
    <Layout data={data}>
        ...
        <Text variant="h5" mb={2}>Doresc o programare</Text>
        {error && (
        ...
        <Text mb={2}>
          ...
          Prețul acestui pachet este de 600 lei.
        </Text>
