...
const Search = ( { data } ) => {
  ...
  const { header, footer, headerMenu, footerMenu, slug } = data || {};
  ...
  return (
    <>
      <Header header={ header } headerMenus={ headerMenu?.edges ?? [] } slug={slug}/>
...
export async function getStaticProps() {
  ...
  return handleRedirectsAndReturnData( defaultProps, data, errors, 'headerMenu' );
}